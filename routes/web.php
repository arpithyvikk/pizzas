...
Route::group(['middleware' => ['auth', 'active']], function() {
	...
	Route::post('products/update', 'ProductController@updateProduct')->name('products.updates');
	...
	// Route::post('pizzas/updatepayment', 'PizzaController@updatePayment')->name('pizza.update-payment');
