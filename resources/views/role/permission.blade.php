                    ...
                    <div class="card-body">
						...
						<div class="table-responsive">
						    <table class="table table-bordered permission-table">
								...
								<tr>
						            <td>{{trans('file.Pizza')}}</td>
						            <td class="text-center">
						                <div class="icheckbox_square-blue" aria-checked="false" aria-disabled="false">
							                <div class="checkbox">
								                @if(in_array("pizzas-index", $all_permission))
								                	<input type="checkbox" value="1" id="pizzas-index" name="pizzas-index" checked>
								                @else
								                	<input type="checkbox" value="1" id="pizzas-index" name="pizzas-index">
								                @endif
								                <label for="pizzas-index"></label>
							                </div>
							            </div>
						            </td>
						            <td class="text-center">
						                <div class="icheckbox_square-blue" aria-checked="false" aria-disabled="false">
							                <div class="checkbox">
								                ...
								                <input type="checkbox" value="1" id="pizzas-add" name="pizzas-add" checked>
								                @else
								                <input type="checkbox" value="1" id="pizzas-add" name="pizzas-add">
								                @endif
								                <label for="pizzas-add"></label>
							                </div>
							            </div>
						            </td>
						            <td class="text-center">
						                <div class="icheckbox_square-blue" aria-checked="false" aria-disabled="false">
							                <div class="checkbox">
								                @if(in_array("pizzas-edit", $all_permission))
								                <input type="checkbox" value="1" id="pizzas-edit" name="pizzas-edit" checked />
								                @else
								                <input type="checkbox" value="1" id="pizzas-edit" name="pizzas-edit">
								                @endif
								                <label for="pizzas-edit"></label>
							                </div>
							            </div>
						            </td>
						            <td class="text-center">
						                <div class="icheckbox_square-blue" aria-checked="false" aria-disabled="false">
							                <div class="checkbox">
								                @if(in_array("pizzas-delete", $all_permission))
								                <input type="checkbox" value="1" id="pizzas-delete" name="pizzas-delete" checked>
								                @else
								                <input type="checkbox" value="1" id="pizzas-delete" name="pizzas-delete">
								                @endif
								                <label for="pizzas-delete"></label>
							            	</div>
						            	</div>
						            </td>
						        </tr>
